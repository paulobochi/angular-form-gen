...
angular.module('fg').run(['$templateCache', function($templateCache){
  ...
  $templateCache.put('angular-form-gen/field-templates/properties/fieldgroup.ng.html', '<div fg-tabs-pane=\"Child\"><div fg-edit=\"{\'showPalette\': false, \'hideCanvasTitle\': true}\" fg-schema=\"field.childs\"></div></div><div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ fieldname: true, displayname: true, tooltip: true }\"></div></div>');
  $templateCache.put('angular-form-gen/field-templates/properties/fieldlist.ng.html', '<div fg-tabs-pane=\"Child\"><div fg-edit=\"{\'showPalette\': false, \'hideCanvasTitle\': true, \'canvasMaxSize\': 1}\" fg-schema=\"field.childs\"></div></div><div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ fieldname: true, displayname: true, tooltip: true }\"></div></div>');
